...
import { mat3, mat4 } from './lib/index.js';
...
/**  @type {Matrix4} */
var leftThighMatrix = new Matrix4().setTranslate(2.5, -8, 0);
/**  @type {Matrix4} */
var rightThighMatrix = new Matrix4().setTranslate(-2.5, -8, 0);
/**  @type {Matrix4} */
var legMatrix = new Matrix4().setTranslate(0, -8, 0);
/**  @type {Matrix4} */
var feetMatrix = new Matrix4().setTranslate(0, -4, 1.5);
...
var legMatrixLocal = new Matrix4().setScale(4, 8, 4);
var feetMatrixLocal = new Matrix4().setScale(4, 2, 7);
        ...
        case "q":
            if (thighAngle < 90) {
                ...
                var currentThighRot = new Matrix4()
                    ...
                    .translate(0, -2, 0);
                leftThighMatrix.setTranslate(2.5, -8, 0).multiply(currentThighRot);
                rightThighMatrix.setTranslate(-2.5, -8, 0).multiply(currentThighRot);
            }
            break;
        case "Q":
            if (thighAngle > -90) {
        ...
        case "w":
            if (legAngle < 0) {
                ...
                var currentLegRot = new Matrix4()
                    ...
                    .translate(0, -4, -2);
                legMatrix.setTranslate(0, -8, 0).multiply(currentLegRot);
            }
            break;
        case "W":
            if (legAngle > -90) {
        ...
        case "e":
            if(feetAngle < 15) {
                ...
                var currentFeetRot = new Matrix4()
                    .setTranslate(0, 0, -3.5)
                    .rotate(-feetAngle, 0, 1, 0)
                    .translate(0, 0, 3.5);
                feetMatrix.setTranslate(0, -4, 1.5).multiply(currentFeetRot);
            }
            break;
        case "E":
            if(feetAngle > -15) {
...
function renderCube(matrixStack, matrixLocal) {
    ...
    gl.uniform4f(loc, 0.0, 1.0, 1.0, 0.0);
...
window.addEventListener("load", (event) => {
    ...
    rotator.setView([0, 0, 1], [0, 1, 0], 45);
